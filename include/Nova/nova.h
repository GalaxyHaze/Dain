...
typedef enum {
    ...
    // Operators
    NOVA_TOKEN_ASSIGN,
    NOVA_TOKEN_PLUS, NOVA_TOKEN_MINUS, NOVA_TOKEN_STAR, NOVA_TOKEN_SLASH,
    NOVA_TOKEN_EQ, NOVA_TOKEN_NE, NOVA_TOKEN_LT, NOVA_TOKEN_GT,
    NOVA_TOKEN_LE, NOVA_TOKEN_GE,
    NOVA_TOKEN_AND, NOVA_TOKEN_OR, NOVA_TOKEN_NOT,

    // Delimiters
    NOVA_TOKEN_LPAREN, NOVA_TOKEN_RPAREN,
    NOVA_TOKEN_LBRACE, NOVA_TOKEN_RBRACE,
    NOVA_TOKEN_LBRACKET, NOVA_TOKEN_RBRACKET,
    NOVA_TOKEN_COMMA, NOVA_TOKEN_COLON, NOVA_TOKEN_SEMICOLON, NOVA_TOKEN_DOT,

    // Control flow keywords (stored as NOVA_TOKEN_KEYWORD with keyword_id)
    NOVA_TOKEN_IF, NOVA_TOKEN_ELSE, NOVA_TOKEN_WHILE, NOVA_TOKEN_FOR,
    NOVA_TOKEN_RETURN, NOVA_TOKEN_BREAK, NOVA_TOKEN_CONTINUE,

    // Special
    NOVA_TOKEN_COMMENT,
    NOVA_TOKEN_WHITESPACE,
    NOVA_TOKEN_UNKNOWN,
    NOVA_TOKEN_EOF
} NovaTokenType;
